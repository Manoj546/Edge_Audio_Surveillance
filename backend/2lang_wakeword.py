...
def process_data():
    ...
    # if scream_val >= 1.3:
    #     situation = "Critical Situation"
    if keyflag == True and hindi_flag == True:
        situation = 'Critical Situation'
    elif keyflag == True or hindi_flag == True: ##Emotion
    ...
    result = {'text': audio_file.filename, 'key_word': key_str[0], 'hindi_str': hindi_str, 'situation': situation}
